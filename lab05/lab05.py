...
class LinkedList:
    ...
    def cursor_insert(self, value):
        ...
        self.cursor = n
        self.cursor.prior.next = self.cursor.next.prior = self.cursor
        self.length += 1
        ### END SOLUTION
    ...
    def insert(self, idx, value):
        ...
        if idx == self.length:
            ...
            for _ in range(idx+1):
                pos = pos.next
            n = LinkedList.Node(value, pos.prior, pos)
            pos.prior.next = n
            pos.prior = n
            self.length += 1
        ### END SOLUTION
    ...
    def __eq__(self, other):
        ...
        ### BEGIN SOLUTION
        if type(other) != LinkedList or len(other) != len(self):
            return False
